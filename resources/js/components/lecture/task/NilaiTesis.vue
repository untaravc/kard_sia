                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive">
                            <div class="row">
                                <div class="col-md-6">
                                    <h5 class="font-weight-bold">Penelitian</h5>
                                    <div class="card" v-if="data.order < 9"
                                ...
                                <div class="col-md-6">
                                    <h5 class="font-weight-bold">Penyajian (presentasi)</h5>
                                    <div class="card" v-if="data.order > 8 && data.order < 12"
                                         v-for="(data, i) in dataDetail.stase_task_log_point" :key="data.order">
                                        <div class="card-body">
                                            <p class="mb-0">{{ data.order }}. {{ data.task_detail.name }}</p>
                                            <vue-slider
                                    ...
                                    <h5 class="font-weight-bold">Kemampuan diskusi dan argumentasi</h5>
                                    <div class="card" v-if="data.order > 11 && data.order < 15"
                                         v-for="(data, i) in dataDetail.stase_task_log_point" :key="data.order">
                                        <div class="card-body">
                                            <p class="mb-0">{{ data.order }}. {{ data.task_detail.name }}</p>
                                            <vue-slider
...
export default {
    ...
    methods: {
        ...
        submitData() {
            this.disable = true;
            axios.post('/cmsd/stase-task-logs-update-score-tesis/' + this.form.stase_task_log_id, {
                params: this.form,
            })
                .then(({data}) => {
