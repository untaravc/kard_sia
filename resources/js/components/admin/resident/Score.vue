                                        ...
                                        <li class="nav-item active">
                                            <table width="100%">
                                                <tr v-for="stase in dataProfile.stase_logs" style="border-top: 1px solid lightblue">
                                                    <td style="width: 38px;">
                                                        <input type="radio" name="stase" v-model="filter.stase_log_id" :value="stase.id" class="m-2" :id="'stase_' + stase.id">
                                                    </td>
                                                    <td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr v-for="data in dataDetail">
                                                ...
                                                <td class="text-right">
                                                    <button v-if="data.status === 'pending'" class="btn btn-wd btn-sm btn-th-dark"
                                                            @click="addModal(data)" >Tambah</button>
                                                    <button v-if="data.admin === 1" class="btn btn-wd btn-sm btn-th-secondary"
