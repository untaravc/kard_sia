    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark"><i class="fa fa-chalkboard-teacher"></i> Tugas Stase
                        </h1>
                    </div>
                </div>
            </div>
                            ...
                            <table class="table table-head-fixed">
                                ...
                                <tr role="row" class="odd" v-for="(data, i) in dataContent.data" :key="data.id">
                                    ...
                                    <td class="action-button">
                                        ...
                                        <router-link :to="`/cmss/task/`+data.id" class="btn btn-sm btn-primary">
                                            <i class="fa fa-eye"></i>
                                        </router-link>
                                    </td>
                                </tr>
