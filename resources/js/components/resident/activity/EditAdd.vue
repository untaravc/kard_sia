                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input v-model="form.place" type="text"
                                               placeholder="ex : online Zoom id: 123123, Ruang Konferensi..."
                                ...
                                <div class="col-12 mt-2">
                                    <button class="btn btn-success" :disabled="disable" style="width: 100%" @click="saveData">
    ...
    methods: {
        ...
        saveData() {
            ...
            axios.patch('/cmsr/activities/' + this.form.id, {
                ...
                alert('Lengkapi nama, jam mulai, dan kategori.');
                this.disable = false;
            })
        },
    },
