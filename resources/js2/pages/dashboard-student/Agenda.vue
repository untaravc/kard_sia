<template>
    <div class="flex flex-col gap-6">
        <div class="flex justify-end">
            <router-link
                class="inline-flex min-h-[38px] items-center gap-1.5 rounded-lg border border-border bg-white px-4 py-2 text-xs font-semibold text-ink active:bg-slate-100"
                to="/blu/activities"
            >
                Manage Activities
