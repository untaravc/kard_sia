<template>
    <div class="rounded-2xl border border-border bg-panel p-6">
        <div class="flex items-center justify-between gap-4">
            <div class="text-lg font-semibold">Pendidikan Tambahan</div>
            ...
            <table class="min-w-full text-left text-sm">
                <thead class="text-xs uppercase text-muted">
                    <tr class="border-b border-border">
                        ...
                        <th class="px-2 py-2 hidden lg:table-cell">Tempat</th>
                        <th class="px-2 py-2 hidden lg:table-cell">Bidang</th>
                        <th class="px-2 py-2 hidden lg:table-cell">Tahun</th>
                        <th class="px-2 py-2 hidden lg:table-cell">Lama Pendidikan</th>
                ...
                <tbody>
                    ...
                    <tr v-for="(detail, index) in educations" :key="detail.id" class="border-b border-border">
        ...
        <Modal :open="modalOpen" title="Pendidikan Tambahan" :closeOnBackdrop="false" @close="closeModal">
            <div class="grid gap-4">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    ...
                    <label class="grid gap-2 text-sm">
                        <span class="text-muted">Lama Pendidikan</span>
                        <input class="w-full rounded-xl border bg-white px-4 py-2.5 text-sm focus:outline-none focus:ring-2"
...
export default {
    ...
    computed: {
        ...
        educations() {
            ...
            return details.filter((item) => item && item.label === 'education');
        },
    },
    methods: {
        truncate(url) {
        ...
        uploadFile(event) {
            ...
            this.uploading = true;
            uploadFirebaseFile({ file, prefix: 'Registration/Education' })
                .then((url) => {
                    if (url) {
